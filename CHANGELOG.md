...
## [1.0.69-beta.1](https://github.com/BboyZaki/morjs/compare/v1.0.69-beta.0...v1.0.69-beta.1) (2023-08-03)

### Features

- **utils:** 修复升级 ts 后部分 api 参数变动后的报错 ([9d12902](https://github.com/BboyZaki/morjs/commit/9d12902a76ffd477a5388c52c6131147c2fff759))
- **utils:** 修复升级 ts 后部分 api 参数变动后的报错 ([1c96262](https://github.com/BboyZaki/morjs/commit/1c962624202f26b434868f63d3ede373b106c870))

## 1.0.69-beta.0 (2023-07-31)

### Bug Fixes

- **cli:** 修复配置变更自动重启可能会触发多次的问题 ([444d453](https://github.com/BboyZaki/morjs/commit/444d45384cef3bcc9f85eb3251148d0cb9600de5))
- **core:** fix wechat npm build support ([32af3e2](https://github.com/BboyZaki/morjs/commit/32af3e2f772909e46e8be84bc4f60820dd00d604))
- **core:** 修复 invokeHook 参数 hookName 的类型报错 ([#78](https://github.com/BboyZaki/morjs/issues/78)) ([3e1cfcb](https://github.com/BboyZaki/morjs/commit/3e1cfcb8d886f509b567383d84c5b087fb512809))
- **core:** 修复支付宝 DSL 下 lifetimes 无值可能导致报错的问题 ([#51](https://github.com/BboyZaki/morjs/issues/51)) ([644f9b2](https://github.com/BboyZaki/morjs/commit/644f9b208ca50af5158ac39af9216465d0dda638))
- **core:** 完善 invokeHook 方法兜底检查，找不到 hook 时打印错误日志，不直接抛错 ([f9f361b](https://github.com/BboyZaki/morjs/commit/f9f361b1f88dee845abb4571d22bf4714e287626))
- **plugin-compiler-alipay:** 优化 sjs 辅助函数注入检查逻辑 ([cb9eb35](https://github.com/BboyZaki/morjs/commit/cb9eb356ff603566bb1bb17f531b53d60bea91f8))
- **plugin-compiler-alipay:** 修复 sjs 辅助文件某些情况下可能被注入多次的问题 ([7781f72](https://github.com/BboyZaki/morjs/commit/7781f725fa9f842785d1d738cd83ae68025fd75b))
- **plugin-compiler-alipay:** 修复微信转支付宝对分包配置的兼容 ([17eb4da](https://github.com/BboyZaki/morjs/commit/17eb4da82182616b2e42c825c3813fdb86889c56))
- **plugin-compiler-web:** 修复 @babel/runtime 依赖缺失 ([93b478f](https://github.com/BboyZaki/morjs/commit/93b478f9cf18848e286ca751dcd30377438a9582))
- **plugin-compiler-web:** 修复 runtime-web chunk 未抽取为单独的文件的问题 ([330eb5c](https://github.com/BboyZaki/morjs/commit/330eb5c61af9eb253e24e3ab06a4425d6ff13c0c))
- **plugin-compiler-web:** 修复 web 组件转换在生产模式下 js 文件名称错误及内容为空的问题 ([7501253](https://github.com/BboyZaki/morjs/commit/750125345e1d37db180d8d3a4de66b171e573339))
- **plugin-compiler-web:** 修复微信 DSL 转 Web 可能会找不到 sjs 文件的问题 ([fc77d21](https://github.com/BboyZaki/morjs/commit/fc77d211d0d8957c1d4b1450a983e3a6328f9e48))
- **plugin-compiler-web:** 修复转 Web 小程序组件库的产物加载入口和文档不一致的问题 ([584809f](https://github.com/BboyZaki/morjs/commit/584809fea95163b2a504d308d31cf037846f17ae))
- **plugin-compiler-wechat:** 修复微信双向绑定在抖音和快手端未正确处理 picker-view 的问题 ([ea4b6c9](https://github.com/BboyZaki/morjs/commit/ea4b6c9feb2f8da981583d5a207b7f46472c811c))
- **plugin-compiler:** fix case where alias is an empty object ([#5](https://github.com/BboyZaki/morjs/issues/5)) ([f1fec85](https://github.com/BboyZaki/morjs/commit/f1fec8522bc9b832f025c67c0d6733960e2f0a83))
...
- **plugin-compiler:** 修复 esm 版本的运行时无法被正确注入小程序转端能力支持的问题 ([b97071d](https://github.com/BboyZaki/morjs/commit/b97071dfc01f39cdf2acf1dd4c99399b06345ef8))
- **plugin-compiler:** 修复 getApp 在分包和插件场景下注入时 export default 导致无法被 commonjs 规范的文件正确引用的问题 ([f47a2c5](https://github.com/BboyZaki/morjs/commit/f47a2c5ed3779daedf055355280b841c2aeee647))
...
- **plugin-compiler:** 修复 web 编译在生产模式下 css 文件可能未被压缩的问题 ([ed509e4](https://github.com/BboyZaki/morjs/commit/ed509e4948025bcb24f76114e1e719a10302c031))
- **plugin-compiler:** 修复全局组件注入可能不生效的问题 ([3fda777](https://github.com/BboyZaki/morjs/commit/3fda777afb2dc2ec2d11bc3c2e2ff63b2b95c1e4))
- **plugin-compiler:** 修复同一个项目中混用支付宝或微信 DSL 可能会导致样式冲突的问题 ([4f0577a](https://github.com/BboyZaki/morjs/commit/4f0577a1a248256c167df5f9dc1d72a2340b73fa))
- **plugin-compiler:** 修复开启 importHelpers 可能失败的问题 ([56a662e](https://github.com/BboyZaki/morjs/commit/56a662e6bfbf5df1d930deb65ddfba2ca738b3a8))
- **plugin-compiler:** 修复开启 processNodeModules 时错误将 runtime-base 中的接口转端从而引发报错的问题 ([f7fd9db](https://github.com/BboyZaki/morjs/commit/f7fd9dbb0bb0cff69c0babdf0e07ad95f6f4c867))
- **plugin-compiler:** 修复异步 require 或 require.async 的参数被跳过解析可能引起运行时报错的问题 ([#66](https://github.com/BboyZaki/morjs/issues/66)) ([50f29b7](https://github.com/BboyZaki/morjs/commit/50f29b7065864e35847134e16f9ef254c6f6c7d4))
- **plugin-compiler:** 修复提取内联 sjs 内容时文件后缀错误以及未执行 sjsParser 的问题 ([3fb9971](https://github.com/BboyZaki/morjs/commit/3fb9971f41ea00b40bbc0f9eb7691ba5a6a629ca))
- **plugin-compiler:** 修复样式文件如果传入 null 或 undefined 会导致 postcss 报错的问题 ([0d0ce21](https://github.com/BboyZaki/morjs/commit/0d0ce211e1ec5cb49bfcf05083ff8263d5f23f81))
- **plugin-compiler:** 修复模版解析器处理多端编译时 attrName 可能无值导致逻辑错误的问题 ([920249f](https://github.com/BboyZaki/morjs/commit/920249f0b2637751a20615e3db8ae448fded77be))
- **plugin-compiler:** 修复由于 peerDependencies 导致的 webpack 多实例问题 ([#4](https://github.com/BboyZaki/morjs/issues/4)) ([323b70b](https://github.com/BboyZaki/morjs/commit/323b70b7826650fb3f90d2efa88d0215fee62da6))
- **plugin-compiler:** 修复运行时自动注入可能会导致转 Web 运行时加载时机错误的问题 ([aad48e9](https://github.com/BboyZaki/morjs/commit/aad48e9ecb8b299b7b9761f3a9483ee33ba7ab6f))
...
- **plugin-composer:** 修复不同配置的集成结果文件 compose-results.json 会相互覆盖的问题 ([fb91ac7](https://github.com/BboyZaki/morjs/commit/fb91ac761783df647b31e16e66bb299cde1c641c))
- **plugin-composer:** 修复监听状态下集成编译可能会错误将当前宿主或分包模块产物进行二次编译的问题 ([0e846c4](https://github.com/BboyZaki/morjs/commit/0e846c4dff0f6bd8a82755306d6344df673548c1))
- **plugin-generator:** 修复 create-mor 在当前目录项目初始化完成提示 ([#14](https://github.com/BboyZaki/morjs/issues/14)) ([21c6df3](https://github.com/BboyZaki/morjs/commit/21c6df387414415d7558a9ff2e0a568c5cbc1a19))
- **plugin-generator:** 修复初始化脚手架时可能缺少 .gitignore 文件的问题 ([d4ae47c](https://github.com/BboyZaki/morjs/commit/d4ae47c111ebb751a986bc0ff05a3a77417ec4ef))
- **plugin-generator:** 修改 morjs 依赖为 \* 以处理无 beta 版本引发的 install 报错 ([#21](https://github.com/BboyZaki/morjs/issues/21)) ([ff997b4](https://github.com/BboyZaki/morjs/commit/ff997b4d68664083add0a66cadc209e669eaf11a))
- **plugin-generator:** 替换脚手架生成的 eslint 配置项，防止 eslint-config-prettier 8.0 所有子包收束到 prettier 后的报错 ([#43](https://github.com/BboyZaki/morjs/issues/43)) ([004ce55](https://github.com/BboyZaki/morjs/commit/004ce55b1fad286f83f25521ff0f1ad87000f58e))
- **plugin-mocker:** 修复 mock JSAPI 的异步方法获取 ESModule 数据需要使用 .default 的问题 ([#55](https://github.com/BboyZaki/morjs/issues/55)) ([7476a47](https://github.com/BboyZaki/morjs/commit/7476a4769b77f210126a34f826fc4425e047ff1d))
- **plugin-mocker:** 修复 windows 下 mock 编译报错的问题 ([#50](https://github.com/BboyZaki/morjs/issues/50)) ([6f78eac](https://github.com/BboyZaki/morjs/commit/6f78eacd3dac0ab9168da34cf9f127945a7b671b))
- **runtime-base:** 修复 qq 等端 request 不执行的问题 ([#54](https://github.com/BboyZaki/morjs/issues/54)) ([52fa701](https://github.com/BboyZaki/morjs/commit/52fa7018d1b0a5798eca184cfd866acf9a09c709))
- **runtime-base:** 修复同步接口抹平结果修改未被正确触发的问题 ([8173706](https://github.com/BboyZaki/morjs/commit/8173706744966929494d85d275cd0032602959d1))
- **runtime-mini:** fix wechat npm build support ([096fb7c](https://github.com/BboyZaki/morjs/commit/096fb7ce31547c71eac1e2c2f316a9f438c7da52))
- **runtime-mini:** replace @morjs/api with @morjs/runtime-base to avoid cycle references ([84b4a0c](https://github.com/BboyZaki/morjs/commit/84b4a0cef834e8bfabad4e2821b3f6414dd89ab9))
- **runtime-mini:** 优化属性监听器执行时机，仅在变更时执行 ([3d0348c](https://github.com/BboyZaki/morjs/commit/3d0348ce8f20633fab9acc57b20a3d16f1fba19f))
- **runtime-mini:** 修复判断 relations 和 externalClasses 参数错误 ([c176e94](https://github.com/BboyZaki/morjs/commit/c176e9426e5cfa64aa5484ebdac7a54fdb690e6d))
- **runtime-mini:** 修复微信转支付宝小程序后组件在 created 阶段无法从 data 中获取 properties 值的问题 ([#58](https://github.com/BboyZaki/morjs/issues/58)) ([07f7ff9](https://github.com/BboyZaki/morjs/commit/07f7ff9d0cf8afc5fa5df6511f7467497a6522cf))
- **runtime-mini:** 修复微信转支付宝的 observer 触发多个 props 问题 ([#27](https://github.com/BboyZaki/morjs/issues/27)) ([8e9b528](https://github.com/BboyZaki/morjs/commit/8e9b5285bd133b91f80341e4f17d5d233d1916f1))
- **runtime-mini:** 修复微信转支付宝部分 Api 无法调用的问题 ([#12](https://github.com/BboyZaki/morjs/issues/12)) ([b824c33](https://github.com/BboyZaki/morjs/commit/b824c3332b3d716beabf51013848f723b73a5b7b))
- **runtime-mini:** 修复支付宝转其他端时 created 生命周期未触发的问题 ([d03262c](https://github.com/BboyZaki/morjs/commit/d03262cb3c768064144d3c661174163bf03fe897))
- **runtime-mini:** 修改生命周期执行顺序，修复微信 DSL 首次传入 props 未执行 observer 的问题 ([#44](https://github.com/BboyZaki/morjs/issues/44)) ([3ee2f9a](https://github.com/BboyZaki/morjs/commit/3ee2f9ac1588e8bce0078bde9b2d56b61e3767f1))
- **runtime-web:** ios 设备无法正常渲染 2.0 版本地图 ([#61](https://github.com/BboyZaki/morjs/issues/61)) ([89be519](https://github.com/BboyZaki/morjs/commit/89be519f2f05fba6523c3d22082675567fff776d))
- **runtime-web:** swiper 默认为 inline 元素导致上下边距异常 ([#39](https://github.com/BboyZaki/morjs/issues/39)) ([4b852c1](https://github.com/BboyZaki/morjs/commit/4b852c153d9e0907f205c989dec7a094402ef166))
- **runtime-web:** 修复 hidden 使用 important 修饰符导致业务对元素布局方式修改失效以及 selectQuery 结果遍历支持 ([ef0cd46](https://github.com/BboyZaki/morjs/commit/ef0cd4666b0302102bc10713547b5d060916a9c3))
- **runtime-web:** 修复 onAppear 在某些特殊场景下可能不执行的问题 ([#37](https://github.com/BboyZaki/morjs/issues/37)) ([1413271](https://github.com/BboyZaki/morjs/commit/14132715b66e17beee16b6de5c437e84812ebcf0))
- **runtime-web:** 修复 switchTab 无法关闭之前打开的页面 ([#8](https://github.com/BboyZaki/morjs/issues/8)) ([ed5e632](https://github.com/BboyZaki/morjs/commit/ed5e6325ce8e3c0e0fb1c6330486a651f4644759))
- **runtime-web:** 修复地图组件 relative 布局错位问题 ([#72](https://github.com/BboyZaki/morjs/issues/72)) ([598863b](https://github.com/BboyZaki/morjs/commit/598863b5112b644eb701bf7ac1d7aa20d84aa497))
- **runtime-web:** 修复父元素未完成挂载时尝试获取 DOM 节点及绑定事件可能会导致报错的问题 ([#34](https://github.com/BboyZaki/morjs/issues/34)) ([3227eeb](https://github.com/BboyZaki/morjs/commit/3227eeb0235a64f5f098734b952395e607e180ea))
- **runtime-web:** 提供 my.SDKVersion 支持 ([ba333b3](https://github.com/BboyZaki/morjs/commit/ba333b33906ca801b9887e27462df595ee0bd2c4))
- **runtime-web:** 解决 swiper item 数据更新异常以及单个 swiper-item 场景无需 autoplay 的问题 ([#74](https://github.com/BboyZaki/morjs/issues/74)) ([5c40253](https://github.com/BboyZaki/morjs/commit/5c402532c70aee994f821d02951c7c6c67ab28d2))
- spell error ([b8d5c4c](https://github.com/BboyZaki/morjs/commit/b8d5c4c9158260e90273b25891761ddb61207bf7))
- **takin:** 修复敏感日志过滤导致原对象或 Map 被修改的问题 ([f5210ba](https://github.com/BboyZaki/morjs/commit/f5210baa07318d6ea983ddce8f9814b882cb1935))
- **utils:** 升级 sass 版本为 1.60.0 确保对 node 12 的支持 ([4e3928e](https://github.com/BboyZaki/morjs/commit/4e3928ed2d5a7efb6ba0ef98655c3e4460ecc016))

### Features

- **cli:** 对外暴露 generateComposeModuleHash 方法方便定制集成能力 ([993d66f](https://github.com/BboyZaki/morjs/commit/993d66fea7421a5503b810b1032fec0eb1ad7ddd))
- **example:** 添加蓝牙转换用例 ([cd87efe](https://github.com/BboyZaki/morjs/commit/cd87efe43f035bda35083022f9be1b1b84c97032))
- **plugin-compiler-alipay:** 优化 sjs 帮助文件的名称生成逻辑 ([30395bb](https://github.com/BboyZaki/morjs/commit/30395bb32d919abf09eeffb0a0fbfd89f317e48d))
- **plugin-compiler-alipay:** 完善微信转支付宝的转端兼容性：处理支付宝不支持 sjs 模块名称为 this 及 组件名称不支持大写的问题 ([b6aa409](https://github.com/BboyZaki/morjs/commit/b6aa4097c82c16e49f3b018570c59efeacd43df0))
- **plugin-compiler-alipay:** 完善支付宝 DSL 的模版字符串和样式对象支持 ([c748f83](https://github.com/BboyZaki/morjs/commit/c748f8386336bd0206441b3b44bbc5ee9fee7c4f))
- **plugin-compiler-alipay:** 完善支付宝转微信 sjs 中 export default function xxx(){} 的转换支持 ([f907bb2](https://github.com/BboyZaki/morjs/commit/f907bb2333b46a4a03e0b1d926f8bd4491aed198))
- **plugin-compiler-alipay:** 完善支付宝转微信不兼容选择器提示信息 ([eacdf5e](https://github.com/BboyZaki/morjs/commit/eacdf5e60898e2ad30533c1407d81c2eca0202b0))
- **plugin-compiler-alipay:** 完善支付宝转微信时模版中对部分方法调用的支持 ([4780b28](https://github.com/BboyZaki/morjs/commit/4780b28140551e0ae5b1d3cfe4e4b139928bb59c))
- **plugin-compiler-alipay:** 添加对 bind:abc-def 事件写法的支持 ([c533d92](https://github.com/BboyZaki/morjs/commit/c533d92e669cb0dcd84598ade3a64e4574a85f77))
- **plugin-compiler-alipay:** 补充部分支付宝原生组件事件配置 ([b1b7f76](https://github.com/BboyZaki/morjs/commit/b1b7f7625f018add0ace22cb338d6ac242ee623c))
- **plugin-compiler-baidu:** 完善微信转百度双向绑定适配以及修复 s-for 指令适配逻辑 ([3d15094](https://github.com/BboyZaki/morjs/commit/3d15094eb983f8148690dda08c80c480474335b5))
- **plugin-compiler-bytedance:** 增加字节小程序双向绑定编译能力支持 ([6a03f1c](https://github.com/BboyZaki/morjs/commit/6a03f1c786e1474418b47d292ed8c9054a8cd87b))
- **plugin-compiler-bytedance:** 新增抖音分包异步化编译支持 ([#46](https://github.com/BboyZaki/morjs/issues/46)) ([6e2ede2](https://github.com/BboyZaki/morjs/commit/6e2ede2782bdbdc259d81deb603fccabc3f8f136))
- **plugin-compiler-kuaishou:** 增加快手小程序双向绑定编译能力支持 ([53e72ee](https://github.com/BboyZaki/morjs/commit/53e72eeb98f54f1300d12166e039da9495bb9284))
- **plugin-compiler-web:** .json 文件支持条件编译 ([#3](https://github.com/BboyZaki/morjs/issues/3)) ([d717375](https://github.com/BboyZaki/morjs/commit/d717375bbad95413c9a23e639a78ec086d07b6e8))
- **plugin-compiler-web:** 优化 Web 编译的 bundle 文件生成名称 ([f07acec](https://github.com/BboyZaki/morjs/commit/f07acecde018d271fb3cd33bb6af60b1953568ad))
- **plugin-compiler-wechat:** 增加微信转其他类似于微信端的双向绑定支持 ([74f5b13](https://github.com/BboyZaki/morjs/commit/74f5b1345ee63aef91f58369328b2338bb277ab0))
- **plugin-compiler:** consumes 和 shared 配置增加别名配置支持 ([fb955ad](https://github.com/BboyZaki/morjs/commit/fb955ad9f0bd964e06357add616e53561dba1190))
- **plugin-compiler:** 优化 processNodeModules 配置开启后对组件库的转端编译支持 ([fcacc95](https://github.com/BboyZaki/morjs/commit/fcacc952f8d18ddc530d0335d41d2217b89c4cb0))
- **plugin-compiler:** 优化分包和插件编译的 getApp 注入逻辑，避免在支付宝小程序上的 externals 生效问题 ([#70](https://github.com/BboyZaki/morjs/issues/70)) ([be79063](https://github.com/BboyZaki/morjs/commit/be790631943efc328145353945dde8c74edf44a5))
- **plugin-compiler:** 优化幽灵依赖和自动注入功能兼容性 ([e5f97e3](https://github.com/BboyZaki/morjs/commit/e5f97e38787a10c3f780e1b0b3a2931d5a0ef4fe))
- **plugin-compiler:** 优化编译相关全局文件名称生成逻辑，允许配置后缀名以避免冲突 ([aae1dad](https://github.com/BboyZaki/morjs/commit/aae1dad13864ee3e4a58786870435a36e4f581d5))
- **plugin-compiler:** 优化项目配置文件载入逻辑，不需要输出项目配置文件时跳过查找 ([a4cda13](https://github.com/BboyZaki/morjs/commit/a4cda13f21690bd2be6c3ebe1da730d6fc813bf0))
- **plugin-compiler:** 升级 typescript 5，处理类型相关报错 ([82b3666](https://github.com/BboyZaki/morjs/commit/82b3666ae33d7c632aef61eeb3b0edadacf10ed4))
- **plugin-compiler:** 完善 processNodeModules 对组件库的解析逻辑支持 ([2b33ef1](https://github.com/BboyZaki/morjs/commit/2b33ef1acfc42960c0ee9cb9813f92fd22e936e3))
- **plugin-compiler:** 完善 transform 编译支持以及允许通过 customEntries 添加额外需要编译的页面或组件 ([82fecc5](https://github.com/BboyZaki/morjs/commit/82fecc524cf87534d213e065c07423133aefe88c))
- **plugin-compiler:** 完善小程序转端运行时自动注入逻辑和兜底检查支持 ([433d43c](https://github.com/BboyZaki/morjs/commit/433d43c85931c93dd05b60065e4dbaa30896fbb8))
- **plugin-compiler:** 完善自定义入口配置文件的解析逻辑，允许指定为非源码目录的文件 ([fb7610c](https://github.com/BboyZaki/morjs/commit/fb7610c7324c9833296497cddc71246c3c458d08))
- **plugin-compiler:** 新增多端组件构建模式支持 ([#75](https://github.com/BboyZaki/morjs/issues/75)) ([3307838](https://github.com/BboyZaki/morjs/commit/3307838d278607d300c390877abe48e40f117acd))
- **plugin-compiler:** 新增编译时自动检测运行时入口函数和 sourceType 类型是否匹配 ([#22](https://github.com/BboyZaki/morjs/issues/22)) ([1096bad](https://github.com/BboyZaki/morjs/commit/1096bad220a1f4807bf657755b18544a241fb39f))
- **plugin-compiler:** 添加幽灵依赖检测功能 ([#7](https://github.com/BboyZaki/morjs/issues/7)) ([9899827](https://github.com/BboyZaki/morjs/commit/989982731d490922bc8f7dbc272ce63461693a28))
- **plugin-composer:** 优化模块集成脚本变化判断逻辑，避免错误判断导致脚本重复执行 ([b4c08fd](https://github.com/BboyZaki/morjs/commit/b4c08fd149943d432b3cb25323c30f426a1df071))
...
- **plugin-composer:** 完善集成临时文件存储逻辑，基于配置名称区分，避免多配置模式下集成缓存冲突 ([cbefb55](https://github.com/BboyZaki/morjs/commit/cbefb55664c89ea94e8e199aca440a3c885603e2))
- **plugin-generator:** create-mor 用户 git 信息改成非必选, 不做输入的校验 ([#15](https://github.com/BboyZaki/morjs/issues/15)) ([fd26ef5](https://github.com/BboyZaki/morjs/commit/fd26ef5ce89f5b70ced1ec6b8980b04008c9992d))
- **plugin-generator:** create-morjs 项目初始化后根据用户输入更新 package.json 的名称和描述 ([#16](https://github.com/BboyZaki/morjs/issues/16)) ([abc41f6](https://github.com/BboyZaki/morjs/commit/abc41f62c84cf7e7478234d4c23cbf58ae1538b7))
- **runtime-base:** 新增 hooks 的 pause、resume 方法，用于暂停/恢复部分 hooks 生命周期的执行 ([#77](https://github.com/BboyZaki/morjs/issues/77)) ([aa712eb](https://github.com/BboyZaki/morjs/commit/aa712ebf2603ecd5b1340f77c0d79e2e709476ad))
- **runtime-mini:** openBluetoothAdapter 返回值兼容 ([f38c46e](https://github.com/BboyZaki/morjs/commit/f38c46ed411abf38e19aa9206f33592ce7a29ea4))
- **runtime-mini:** 优化 observers 在支付宝端的兼容支持 ([b610e3f](https://github.com/BboyZaki/morjs/commit/b610e3f4d1746a105ee0ca07e5ffc853b2d6947e))
- **runtime-mini:** 修复微信转支付宝 data 更新未触发 observers 的问题 ([#9](https://github.com/BboyZaki/morjs/issues/9)) ([8b8ac97](https://github.com/BboyZaki/morjs/commit/8b8ac97ce378273a9f23b807d025c34b39474cc0))
- **runtime-mini:** 增加字节小程序及快手小程序运行时双向绑定支持 ([653767f](https://github.com/BboyZaki/morjs/commit/653767f44d954fedfd435cbc4a86889e310d1e30))
- **runtime-mini:** 增加微信转支付宝 relations 支持 ([66f8dc0](https://github.com/BboyZaki/morjs/commit/66f8dc081abecd882e81f756fbf7f4aa51bf19a9))
- **runtime-mini:** 增加微信转支付宝外部样式类支持 ([d9202e6](https://github.com/BboyZaki/morjs/commit/d9202e645e4d7f7da5936e039259f4cd33a5ddd6))
- **runtime-mini:** 增加微信转支付宝的 getSystemInfo、getSystemInfoSync、getSystemInfoAsync 等接口抹平支持 ([431f7e9](https://github.com/BboyZaki/morjs/commit/431f7e92d1ffeb2b26f519c9729aab3fd7c9b6eb))
- **runtime-mini:** 完善 selectComponent、selectAllComponents、selectOwnerComponent 组件或页面示例方法支持 ([dd809eb](https://github.com/BboyZaki/morjs/commit/dd809ebb17f6b37bd1d038feb30acf47779fa773))
- **runtime-mini:** 对齐最新 lifetimes 的官方功能，优先使用官方提供的 lifetimes 方法，兜底使用 mor 的自实现 ([#38](https://github.com/BboyZaki/morjs/issues/38)) ([0044d4a](https://github.com/BboyZaki/morjs/commit/0044d4a8cc86fc619c505f664d098c033fb7d8a7))
- **runtime-mini:** 支付宝&微信蓝牙方法交叉兼容 ([20251dc](https://github.com/BboyZaki/morjs/commit/20251dc1d268b84f9ed1724c2bd6c97ae4b55685))
- **runtime-mini:** 添加 triggerEvent 方法对 bind:abc-def 的支持 ([843435e](https://github.com/BboyZaki/morjs/commit/843435e733dd4ca2b4c4be9e3dffcd3fab2d475f))
- **runtime-web:** caniuse 函数增加部分能力判断 ([#71](https://github.com/BboyZaki/morjs/issues/71)) ([a45cd02](https://github.com/BboyZaki/morjs/commit/a45cd02bb0ee7f0a3ce393504d5a94b1f3f93341))
- **runtime-web:** fields 调用和 scrollOffset,boundingClientRect 调用隔离 ([#42](https://github.com/BboyZaki/morjs/issues/42)) ([f6d23e1](https://github.com/BboyZaki/morjs/commit/f6d23e1accc72d1b8140ffb7c0475518ec9394b7))
- **runtime-web:** getSystemInfo 接口补充 SDKVersion 版本信息 ([037eaef](https://github.com/BboyZaki/morjs/commit/037eaef91ac7c0b82b6c533a03e5a5b95b1dd184))
- **runtime-web:** selectorQuery 方法重构 & 支持 fields 查询 ([#41](https://github.com/BboyZaki/morjs/issues/41)) ([902ffb7](https://github.com/BboyZaki/morjs/commit/902ffb788899425cdaf46ffaaec0fea6aea0124a))
- **runtime-web:** setClipboard 增加 queryCommand 实现方式 & 可以通过配置强切实现方式 ([#32](https://github.com/BboyZaki/morjs/issues/32)) ([3b02ed7](https://github.com/BboyZaki/morjs/commit/3b02ed7ba37a9950916b590246552b2fb192c4fa))
- **runtime-web:** tabbar 组件之间的切换方法由 navigateTo 切换为 switchTab 行为与小程序保持一致 ([b0f29ad](https://github.com/BboyZaki/morjs/commit/b0f29ad8428564dbd2c6a5519b1d355937bdfbff))
- **runtime-web:** 修复转 Web 页面相对路径跳转支持 ([#20](https://github.com/BboyZaki/morjs/issues/20)) ([c82b30d](https://github.com/BboyZaki/morjs/commit/c82b30d34864a6f88c6bfd5c7193e8404eb6a2c9))
- **runtime-web:** 元素获取适配 & 配置读取优先级调整 ([#68](https://github.com/BboyZaki/morjs/issues/68)) ([0f4381d](https://github.com/BboyZaki/morjs/commit/0f4381d5de409a77f93adefe4a9a668bb8473230))
- **runtime-web:** 地图组件支持自定义样式 ([#76](https://github.com/BboyZaki/morjs/issues/76)) ([78e92a3](https://github.com/BboyZaki/morjs/commit/78e92a30b9bb17c82aa9547b804a934b5cadc9ac))
- **runtime-web:** 地图重构 & 支持高级定制渲染 ([#60](https://github.com/BboyZaki/morjs/issues/60)) ([eda6b66](https://github.com/BboyZaki/morjs/commit/eda6b66fc8f2dd8c76e15ab881dc68cf07be8ba6))
- **takin:** 优化生成器逻辑增加模版解析对 <%_ 或 _%> 或 -%> 的支持 ([1982ed6](https://github.com/BboyZaki/morjs/commit/1982ed631ac1ae5aedf7a0d00092ccf433fc5cd7))
- **takin:** 优化生成器逻辑增加模版解析对 <%_ 或 _%> 或 -%> 的支持 ([#57](https://github.com/BboyZaki/morjs/issues/57)) ([e82bb63](https://github.com/BboyZaki/morjs/commit/e82bb63c23e27f8094083be6057e724a5fd7c0fa))
- **utils:** 优化全局集成应用信息的名称生成规则 ([fcbc491](https://github.com/BboyZaki/morjs/commit/fcbc491dd7b44178b8c5f9a5f30e00a1d7cf1257))
- **utils:** 全局文件名称常量方法支持配置后缀用于规避文件冲突 ([7d99e50](https://github.com/BboyZaki/morjs/commit/7d99e5097d3a49537e2335c58656c4a1f81d055f))
- **utils:** 删除 cjstoesm 依赖，抽离相关方法 ([c9ea988](https://github.com/BboyZaki/morjs/commit/c9ea9883b769fd2b3e87356d053ca9a2306ef4c9))
- **utils:** 提供通用 execCommands 方法便于执行脚本及错误处理 ([36dfc64](https://github.com/BboyZaki/morjs/commit/36dfc64342f3dff3b240ced7b3f4335c60cd7180))
- 添加发布 [@zakijs](https://github.com/zakijs) 配置 ([8169946](https://github.com/BboyZaki/morjs/commit/8169946d7d0a436a200cbe68c4ec26176373a133))
- 添加蓝牙转换方法 ([fd6fcc4](https://github.com/BboyZaki/morjs/commit/fd6fcc461bc32ec5cb89cfb3444728c2e6774189))

### Performance Improvements

- 删除不必要用例 ([a306be7](https://github.com/BboyZaki/morjs/commit/a306be7b7229e513110e9bb08dc8956538228272))
